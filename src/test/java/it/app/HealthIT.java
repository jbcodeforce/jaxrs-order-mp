...
public class HealthIT {
  ...
  public void testIfServicesAreUp() {
    endpointData.put("OrderManagementResource Liveness Check", "UP");
    servicesStates = HealthITUtil.connectToHealthEndpoint(200, HEALTH_ENDPOINT);
    checkStates(endpointData, servicesStates);
  }

  @Test
  public void testReadiness() {
    endpointData.put("OrderManagementResource Readiness Check", "UP");

    servicesStates = HealthITUtil.connectToHealthEndpoint(200, READINESS_ENDPOINT);
    checkStates(endpointData, servicesStates);
  }
  ...
  public void testLiveness() {
    ...
    servicesStates = HealthITUtil.connectToHealthEndpoint(200, LIVENES_ENDPOINT);
    checkStates(endpointData, servicesStates);
  }
